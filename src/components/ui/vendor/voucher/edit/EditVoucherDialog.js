...
import { EditVoucherVendor } from "@/api/vendor/EditVoucherVendor";
...
export default function EditVoucherDialog(props) {
  const onFinish = async (values) => {
    let final = { ...values, vendor_id: props.voucher.vendor_id };
    final.expires = dayjs(final.expires).format("YYYY/MM/DD");
    const message = await EditVoucherVendor(
      props.voucher.discount_id,
      final,
      props.token
    );
    await props.mutate();
        ...
        <DialogContent dividers>
          ...
          <Form
            ...
            initialValues={{
              ...
              minPrice: props.voucher.minPrice,
              discount: props.voucher.discount,
              mdPrice: props.voucher.mdPrice,
              expires: dayjs(props.voucher.expires, "YYYY/MM/DD"),
            }}
          >
            <div className={Styles["add-user-field-container"]}>
              ...
              <Input
                ...
                defaultValue={props.voucher.discount_id}
                disabled
              />
            </div>
            <div className={Styles["add-user-field-container"]}>
            ...
            <div className={Styles["add-user-field-container"]}>
              ...
              <Form.Item
                ...
                rules={[
                  ...
                  ({ getFieldValue }) => ({
                    validator(_, value) {
                      const priceValue = getFieldValue("minPrice");
